...
<head>
  ...
  <title>IMSU ENTREPRENUERSHIP</title>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>About Us</h2>
          <p>Entrepreneurship is the process of designing, launching, and running a new business venture. It involves taking on financial risks in the hope of making a profit. Entrepreneurs are innovative individuals who identify opportunities, gather resources, and organize them to create value in the market.</p>
        </div>
...
<!--                 <p class="fst-italic">Consequuntur inventore voluptates consequatur aut vel et. Eos doloribus expedita. Sapiente atque consequatur minima nihil quae aspernatur quo suscipit voluptatem.</p>
 -->
                ...
                <p>The most obvious use is starting your own venture, whether it's a small business, tech startup, or social enterprise</p>
                ...
                <p>Entrepreneurs excel at identifying problems and finding creative solutions, which can be valuable in any industry or role.
                </p>
                ...
                <p> Entrepreneurs must be adaptable and able to navigate uncertainty, a skill that's useful in today's rapidly changing world.
                </p>
      ...
      <div class="container"  data-aos="zoom-out">
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8 col-md-6 c">
            <h3>Our Mission</h3>
            <p>"We embrace creativity, collaboration, empowerment, inclusivity, integrity, continuous learning, resilience, community, impact, and excellence to drive entrepreneurial success, fostering a supportive ecosystem where all aspiring entrepreneurs have equal opportunities to succeed, upholding the highest standards of ethical conduct, promoting lifelong learning for adaptation and growth, encouraging perseverance through challenges, nurturing a diverse and inclusive community for shared learning and collaboration, committed to making a positive impact on society and the environment through sustainable entrepreneurship, and continuously striving for excellence in delivering high-quality support to our entrepreneurial community."
            </p>
    ...
    <!-- ======= Services Section ======= -->
    <section id="instructors" class="services">
      <div class="container" data-aos="fade-up">
    ...
    <section id="skills" class="portfolio" data-aos="fade-up">
      ...
      <div class="container">
        ...
        <div class="section-header">
          <h2>Skills</h2>
          <p>List of skill course offered in Entrepreneurship</p>
        </div>
      ...
      <div class="container-fluid" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry" data-portfolio-sort="original-order">
          ...
          <ul class="portfolio-flters">
            ...
            <li data-filter=".filter-product">Craftsmanship</li>
    ...
    <!-- ======= Team Section ======= -->
    <section id="directors" class="team">
      <div class="container" data-aos="fade-up">
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-header">
          <h2>Contact Us</h2>
          <p>Locate Imo State University Using the Map Source</p>
        </div>

      </div>

      <div class="map">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15885.585427655249!2d7.04225140020409!3d5.508029699402009!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x104259fd305c0295%3A0xaf3232abd76db637!2sImo%20state%20university!5e0!3m2!1sen!2sng!4v1713206943506!5m2!1sen!2sng" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div><!-- End Google Maps -->
      ...
      <div class="container">
        ...
        <div class="row gy-5 gx-lg-5">
          ...
          <div class="col-lg-4">
            ...
            <div class="info">
              <h3>Get in touch</h3>
              <p>Pls, Kindly Send Us a message to reach out to us</p>

              <div class="info-item d-flex">
                <i class="bi bi-geo-alt flex-shrink-0"></i>
                <div>
                  <h4>Location:</h4>
                  <p>G25R+6W6, Ugwu Orji, Owerri 460108, Imo</p>
                </div>
              </div><!-- End Info Item -->
